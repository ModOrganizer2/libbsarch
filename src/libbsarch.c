...
#define UNUSED (void) (_)

#define RETURN_EMPTY_RESULT_MESSAGE \
    bsa_result_message_t var = {1, L"Invalid usage"}; \
    return var;

#define RETURN_EMPTY_RESULT_MESSAGE_BUFFER \
    bsa_result_message_buffer_t var = {{0, NULL}, {1, L"Invalid usage"}}; \
    return var;
...
{
    RETURN_EMPTY_RESULT_MESSAGE_BUFFER;
}
